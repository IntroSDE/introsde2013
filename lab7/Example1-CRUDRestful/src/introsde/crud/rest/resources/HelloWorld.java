...
public class HelloWorld {
	...
	public String sayHelloHtmlToPerson(@PathParam("name") String name,
		...
		// QueryParams can be used as optional parameters that you use if they
		// are present
		//
		if (age > 0) {
			printAlsoAge = " You are " + age
					+ "years old, but don't worry. It's never late to learn!";
		}

		return "<html> " + "<title>" + "Hello Jersey" + "</title>"
				+ "<body><h1>" + "Hello " + name + ". Welcome to Jersey REST."
				+ printAlsoAge + "</body></h1>" + "</html> ";
	}
}
